...
await mkdir('dist');
for (const file of ['index.html','styles.css','date-utils.js','waterdrop-utils.js','recurring-utils.js','app.js','sw.js','manifest.webmanifest','icon.svg','icon-192.png','icon-512.png']) await copyFile(file, `dist/${file}`);
